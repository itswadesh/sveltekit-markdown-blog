...
published: '2019-10-20T00:00:00.000+08:00'
updated: '2019-10-20T12:00:00.000+08:00'
tags: ['nodejs', 'angularjs', 'mongodb', 'appointment booking']
series: false
cover: ./simple-appointment-booking-using-angularjs.png
coverStyle: 'TOP'
canonical_url: false
summary: "In this tutorial, we will create a simple, real and single page Appointment Booking web application using Javascript Fullstack"
---
